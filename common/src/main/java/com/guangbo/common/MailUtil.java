...
/**
 * Created by MiaoJinlong on 2017/5/14.
 */
public class MailUtil {
    public static String myEmailAccount = "gaoguangbol@163.com";
    public static String myEmailPassword = "1013iloveu";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "miaojinlong_z@163.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String body)
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "WenYou", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "XX用户", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("提示邮件", "UTF-8");
    ...
    public static void main(String[] args) throws Exception {
        MailUtil.sendTo("验证邮箱","miaojinlong_z@163.com");
    }
}
